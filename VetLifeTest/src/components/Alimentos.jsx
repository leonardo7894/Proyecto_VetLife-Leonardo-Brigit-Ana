...
export default function Alimentos() {
  ...
  const productos = [
    { id: 1, descripcion: "Alimento1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Alimento2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Alimento3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Alimento4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Alimento5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Alimento6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Alimento7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Alimento8", imagen: "./akkaka.jpeg" },
  ];
