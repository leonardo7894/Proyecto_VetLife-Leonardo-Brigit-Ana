...
export default function Camas() {
  ...
  const productos = [
    { id: 1, descripcion: "Cama1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Cama2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Cama3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Cama4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Cama5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Cama6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Cama7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Cama8", imagen: "./akkaka.jpeg" },
  ];
