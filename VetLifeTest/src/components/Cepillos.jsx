...
export default function Cepillos() {
  const [carrito, setCarrito] = useState([]);
  const [popupVisible, setPopupVisible] = useState(false);

  const productos = [
    { id: 1, descripcion: "Ceoillo1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Ceoillo2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Ceoillo3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Ceoillo4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Ceoillo5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Ceoillo6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Ceoillo7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Ceoillo8", imagen: "./akkaka.jpeg" },
  ];
