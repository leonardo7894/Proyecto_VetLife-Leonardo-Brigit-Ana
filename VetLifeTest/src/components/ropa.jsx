...
export default function Ropa() {
  ...
  const productos = [
    { id: 1, descripcion: "Ropa1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Ropa2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Ropa3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Ropa4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Ropa5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Ropa6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Ropa7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Ropa8", imagen: "./akkaka.jpeg" },
  ];
