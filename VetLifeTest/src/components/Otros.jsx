...
export default function Otros() {
  ...
  const productos = [
    { id: 1, descripcion: "Otro1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Otro2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Otro3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Otro4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Otro5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Otro6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Otro7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Otro8", imagen: "./akkaka.jpeg" },
  ];
