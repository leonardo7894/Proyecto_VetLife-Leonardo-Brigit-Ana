...
export default function Pastillas() {
  ...
  const productos = [
    { id: 1, descripcion: "Pastilla1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Pastilla2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Pastilla3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Pastilla4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Pastilla5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Pastilla6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Pastilla7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Pastilla8", imagen: "./akkaka.jpeg" },
  ];
