...
export default function Jarabes() {
  const [carrito, setCarrito] = useState([]);
  const [popupVisible, setPopupVisible] = useState(false);

  const productos = [
    { id: 1, descripcion: "Jarabe1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Jarabe2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Jarabe3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Jarabe4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Jarabe5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Jarabe6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Jarabe7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Jarabe8", imagen: "./akkaka.jpeg" },
  ];
