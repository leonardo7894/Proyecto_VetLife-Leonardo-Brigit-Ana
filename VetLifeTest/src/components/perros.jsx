...
export default function Perros() {
  ...
  const productos = [
    { id: 1, descripcion: "Perro1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Perro2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Perro3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Perro4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Perro5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Perro6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Perro7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Perro8", imagen: "./akkaka.jpeg" },
  ];
 ...
 localStorage.setItem("carrito",JSON.stringify(nuevoCarrito));
  ...
  return (
    <div className="titulos">
      <h1>Cocomidadad para peperros</h1>
