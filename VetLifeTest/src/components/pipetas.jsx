...
export default function Pipetas() {
  const [carrito, setCarrito] = useState([]);
  const [popupVisible, setPopupVisible] = useState(false);

  const productos = [
    { id: 1, descripcion: "Pipeta1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Pipeta2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Pipeta3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Pipeta4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Pipeta5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Pipeta6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Pipeta7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Pipeta8", imagen: "./akkaka.jpeg" },
  ];
