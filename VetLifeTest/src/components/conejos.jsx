...
export default function Conejos() {
  const [carrito, setCarrito] = useState([]);
  const [popupVisible, setPopupVisible] = useState(false);

  const productos = [
    { id: 1, descripcion: "Conejo1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Conejo2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Conejo3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Conejo4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Conejo5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Conejo6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Conejo7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Conejo8", imagen: "./akkaka.jpeg" },
  ];
