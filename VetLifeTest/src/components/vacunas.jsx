...
export default function Vacunas() {
  ...
  const productos = [
    { id: 1, descripcion: "Vacuna1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Vacuna2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Vacuna3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Vacuna4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Vacuna5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Vacuna6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Vacuna7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Vacuna8", imagen: "./akkaka.jpeg" },
  ];
