...
export default function Transportadoras() {
  ...
  const productos = [
    { id: 1, descripcion: "Transportadora1", imagen: "./akkaka.jpeg" },
    { id: 2, descripcion: "Transportadora2", imagen: "./akkaka.jpeg" },
    { id: 3, descripcion: "Transportadora3", imagen: "./akkaka.jpeg" },
    { id: 4, descripcion: "Transportadora4", imagen: "./akkaka.jpeg" },
    { id: 5, descripcion: "Transportadora5", imagen: "./akkaka.jpeg" },
    { id: 6, descripcion: "Transportadora6", imagen: "./akkaka.jpeg" },
    { id: 7, descripcion: "Transportadora7", imagen: "./akkaka.jpeg" },
    { id: 8, descripcion: "Transportadora8", imagen: "./akkaka.jpeg" },
  ];
